...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ProgressBar progressBar = (ProgressBar) mRootView.findViewById(R.id.progressBarDetail);
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            Log.e("ArticleDetailFragment", "Something went wrong. cursor should not be null");
            Snackbar snackbar = Snackbar
                    .make(mRootView.findViewById(R.id.coordinatorLayoutDetail), "Something went wrong. Please check your connection and try again.", Snackbar.LENGTH_LONG);
            snackbar.show();
        }
    }
